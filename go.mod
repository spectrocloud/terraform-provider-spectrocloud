...
require (
	...
	github.com/spectrocloud/palette-sdk-go v0.0.0-20260521135818-be56c99adef7
...
// Local dev only — uncomment when iterating on sibling palette-sdk-go clone. Must stay commented for CI.
