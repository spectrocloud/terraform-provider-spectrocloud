...
```console
terraform import spectrocloud_cluster_apache_cloudstack.example example_id:project
```

```console
terraform import spectrocloud_cluster_apache_cloudstack.example cloudaccount_name:project
```
