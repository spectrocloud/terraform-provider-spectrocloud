...
```console
terraform import spectrocloud_cloudaccount_apache_cloudstack.cloud_account_uid:project
```

```console
terraform import spectrocloud_cloudaccount_apache_cloudstack.cloud_account_name:project
```
