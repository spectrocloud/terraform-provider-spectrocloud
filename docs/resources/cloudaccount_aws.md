...
```console
terraform import spectrocloud_cloudaccount_aws.example example_id:project
```

```console
terraform import spectrocloud_cloudaccount_aws.example cloudaccount_name:project
```
