...
```console
terraform import spectrocloud_cloudaccount_openstack.example example_id:project
```

```console
terraform import spectrocloud_cloudaccount_openstack.example cloudaccount_name:project
```
