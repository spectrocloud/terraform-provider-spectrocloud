...
```console
terraform import spectrocloud_cloudaccount_openstack.cloud_account_id:project
```

```console
terraform import spectrocloud_cloudaccount_openstack.cloud_account_name:project
```
