...
```console
terraform import spectrocloud_cloudaccount_vsphere.cloud_account_id:project
```

```console
terraform import spectrocloud_cloudaccount_vsphere.cloud_account_name:project
```
