...
```console
terraform import spectrocloud_cloudaccount_custom.example example_id:project
```

```console
terraform import spectrocloud_cloudaccount_custom.example cloudaccount_name:project:custom_cloud_name
```
