...
resource "spectrocloud_cluster_profile" "apache_cloudstack_profile" {
  name        = "e2e-apache-cloudstack-full-stack"
  description = "Comprehensive Apache CloudStack cluster profile for the end-to-end usecase example"
  ...
  profile_variables {
    ...
    variable {
      ...
      Demonstrates the full spectrocloud_cluster_apache_cloudstack attribute surface.
      EOT
    }
  }
}
