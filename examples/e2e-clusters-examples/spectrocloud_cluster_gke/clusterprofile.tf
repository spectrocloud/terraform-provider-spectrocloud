...
resource "spectrocloud_cluster_profile" "gke_profile" {
  name        = "e2e-gke-full-stack"
  description = "Comprehensive GKE cluster profile for the end-to-end usecase example"
  cloud       = "gke"
  type        = "cluster"
  context     = "project"
  ...
  profile_variables {
    ...
    variable {
      ...
      Demonstrates the full spectrocloud_cluster_gke attribute surface.
      EOT
    }
  }
}
