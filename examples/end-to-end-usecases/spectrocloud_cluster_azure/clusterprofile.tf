...
resource "spectrocloud_cluster_profile" "azure_profile" {
  name        = "e2e-azure-full-stack"
  description = "Comprehensive Azure cluster profile for the end-to-end usecase example"
  cloud       = "azure"
  type        = "cluster"
  context     = "project"
  ...
  profile_variables {
    ...
    variable {
      ...
      Demonstrates the full spectrocloud_cluster_azure attribute surface.
      EOT
    }
  }
}
