...
resource "spectrocloud_cluster_profile" "gcp_profile" {
  name        = "e2e-gcp-full-stack"
  description = "Comprehensive GCP cluster profile for the end-to-end usecase example"
  cloud       = "gcp"
  type        = "cluster"
  context     = "project"
  ...
  profile_variables {
    ...
    variable {
      ...
      Demonstrates the full spectrocloud_cluster_gcp attribute surface.
      EOT
    }
  }
}
