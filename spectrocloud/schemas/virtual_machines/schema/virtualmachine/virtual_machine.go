...
import (
	...
	"github.com/spectrocloud/terraform-provider-spectrocloud/spectrocloud/schemas/virtual_machines/schema/virtualmachineinstance"
	"github.com/spectrocloud/terraform-provider-spectrocloud/spectrocloud/schemas/virtual_machines/utils"
)
...
func VirtualMachineFields() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"affinity": k8s.AffinitySchema(), //Need Clarification
		"scheduler_name": {
			Type:        schema.TypeString,
