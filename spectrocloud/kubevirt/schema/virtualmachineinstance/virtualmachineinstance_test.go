...
func TestExpandProbe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := expandProbeToVM(tt.input)
...
func TestFlattenProbe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := flattenProbeFromVM(tt.input)
...
// 	tests := []struct {
// 		name     string
// 		input    *models.V1VMContainerDiskSource
// 		expected []interface{}
// 	}{
// 		{
// 			name: "Empty input",
// 			input: &models.V1VMContainerDiskSource{
// 				Image: utils.PtrToString(""),
// 			},
// 			expected: []interface{}{
// 				map[string]interface{}{
// 					"image_url": "",
