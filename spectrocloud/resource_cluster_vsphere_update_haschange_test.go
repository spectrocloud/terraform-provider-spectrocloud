...
func baseVsphereUpdateAttrs() map[string]string {
...
func TestResourceClusterVsphereUpdate_HasChange_Suite(t *testing.T) {
	updater := func(ctx context.Context, d *schema.ResourceData, m interface{}) any {
		return resourceClusterVsphereUpdate(ctx, d, m)
	}
	runUpdateHasChangeSuite(t, "vSphere", resourceClusterVsphere(), "test-cluster-uid",
		baseVsphereUpdateAttrs(), updater, false)
}
