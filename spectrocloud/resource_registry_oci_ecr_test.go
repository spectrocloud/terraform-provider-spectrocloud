...
func TestValidateRegistryCred(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "Skip validation when providerType is not pack/helm/zarf",
			client:       unitTestMockAPIClient,
			registryType: "basic",
			...
			ecrSpec:     nil,
			expectError: false,
			description: "Should skip validation when providerType is outside the pack/helm/zarf set",
		},
		{
			name:         "Skip basic validate call when basicSpec is nil",
			client:       unitTestMockAPIClient,
			registryType: "basic",
			providerType: "helm",
			isSync:       true,
			...
			ecrSpec:      nil,
			expectError:  false,
			description:  "Should skip the SDK call (and return nil) when basicSpec is nil",
		},
		{
			name:         "Skip ecr validate call when ecrSpec is nil",
			client:       unitTestMockAPIClient,
			registryType: "ecr",
			providerType: "helm",
			isSync:       true,
			...
			ecrSpec:      nil,
			expectError:  false,
			description:  "Should skip the SDK call (and return nil) when ecrSpec is nil",
		},
		{
			name:         "Successfully validate ecr registry",
			client:       unitTestMockAPIClient,
			registryType: "ecr",
			providerType: "pack",
			isSync:       true,
			...
			expectError: false,
			description: "Should successfully validate ecr registry when all conditions are met",
		},
		{
			name:         "Error from ValidateOciBasicRegistry surfaces",
			...
			ecrSpec:     nil,
			expectError: true,
			description: "Should surface the SDK error when ValidateOciBasicRegistry fails",
		},
		{
			name:         "Error from ValidateOciEcrRegistry surfaces",
			client:       unitTestMockAPINegativeClient,
			registryType: "ecr",
			providerType: "zarf",
			isSync:       true,
			...
			expectError: true,
			description: "Should surface the SDK error when ValidateOciEcrRegistry fails",
		},
	}
